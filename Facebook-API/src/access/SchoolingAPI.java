...
public class SchoolingAPI extends RestApplication {
  ...
  public Response getAll() {
    ...
    response = Response.status(Response.Status.OK).entity(new DaoSchooling(conn).getAll()).build();
    return response;
  }
  ...
  public Response getSchooling(@QueryParam("id") int id, @QueryParam("iduser") int iduser) {
    ...
    if (s != null) response = Response.status(Response.Status.OK).entity(s).build();
  ...
  public Response createSchooling(
      @FormParam("name") String name,
      @FormParam("address") String address,
      @FormParam("type") String type,
      @FormParam("beginDate") String beginDate,
      @FormParam("endDate") String endDate,
      @FormParam("graduate") String graduate,
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Response updateSchooling(
      @FormParam("schoolingId") String schoolingId,
      @FormParam("beginDate") String beginDate,
      @FormParam("endDate") String endDate,
      @FormParam("graduate") String graduate,
      @FormParam("user") String userid) {
