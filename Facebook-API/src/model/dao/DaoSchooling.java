...
public class DaoSchooling extends Dao<Schooling> {
    ...
    public boolean create(Schooling obj) {
        ...
        try{
            ...
            stmt.setDate(6,java.sql.Date.valueOf(obj.getBeginDate().toInstant().atZone(ZoneId.of("Europe/Brussels")).toLocalDate()));
            stmt.setDate(7,java.sql.Date.valueOf(obj.getEndDate().toInstant().atZone(ZoneId.of("Europe/Brussels")).toLocalDate()));
    ...
    @Override
    public Schooling find(int id) { return null; }
