...
public class DaoLikeComment extends Dao<Like> {
  ...
  public boolean create(Like obj) {
    ...
    params.add("comment", String.valueOf(obj.getComment().getId()));
    String response =
        webResource
            .path("LikeComment/CreateLike")
  ...
  public List<Like> getAll() {
    String response =
        webResource.path("LikeComment/GetAll").accept(MediaType.APPLICATION_JSON).get(String.class);
    ObjectMapper mapper = new ObjectMapper();
