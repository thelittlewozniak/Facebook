    ...
    <div class="full col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="#" class="pull-right">Le Christ Cosmique</a> <h4>Facebook fait
                        peau neuve!</h4></div>
                    <div class="panel-body">
                    ...
                    <form class="form" action="/Facebook_intelliJ_war_exploded/Register/" method="post">
                        ...
                        <div class="input-group text-center">
                            <div class="input-group-lg form-group">
                                ...
                                <input class="form-control input-lg pull-right" placeholder="Enter your email address"
                            ...
                            <div class="input-group-lg form-group">
                                ...
                                <input class="form-control input-lg pull-right" placeholder="Enter your Lastname"
